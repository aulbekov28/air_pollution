...
(function() {
    ...
    var OVERLAY_TYPES = {
        "temp": {min: -50,   max: 50,    scale: "line", precision: 1, label: "Temperature", unit: "ºC"},
        //"hum":  {min: 0,     max: 100,   scale: "line", precision: 1, label: "Humidity", unit: "%"},
        //"wv":   {min: 1,     max: 20,    scale: "log",  precision: 1, label: "Wind Velocity", unit: " m/s"},
        //"in":   {min: 0.1,   max: 4.0,   scale: "log",  precision: 2, label: "Insolation", unit: ' MJ/m<span class="sup">2</span>'},
        ////"no":   {min: 0.001, max: 0.600, scale: "log",  precision: 0, label: "Nitric Monoxide", unit: " ppb", multiplier: 1000},
        "no2":  {min: 0.001, max: 0.200, scale: "log",  precision: 0, label: "Nitrogen Dioxide", unit: " ppb", multiplier: 1000},
        //"nox":  {min: 0.001, max: 0.600, scale: "log",  precision: 0, label: "Nitrogen Oxides", unit: " ppb", multiplier: 1000},
        //"ox":   {min: 0.001, max: 0.250, scale: "log",  precision: 0, label: "Photochemical Oxidants", unit: " ppb", multiplier: 1000},
        "so2":  {min: 0.001, max: 0.110, scale: "log",  precision: 0, label: "Sulfur Dioxide", unit: " ppb", multiplier: 1000},
    ...
    function plotStations(data, mesh) {
        ...
        var features = [];
        let raw;
        data.samples.forEach(function(e) {
            if (isValidSample(e)) {
                features.push({
                    type: "Features",
